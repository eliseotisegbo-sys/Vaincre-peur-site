      ...
      <div className="wrap">
        <div className="section-head text-center">
          ...
          <p className="intro centered">
            Prenez quelques secondes pour mesurer la différence lorsque l'appréhension ne dicte plus
            vos décisions professionnelles et personnelles.
          </p>
        </div>

        <div className="contrast-grid">
          <div className="contrast-card before-card hover-lift">
            <div className="contrast-tag before-tag">Situation actuelle : hésitation</div>
          ...
          <div className="contrast-card after-card hover-lift">
            <div className="contrast-tag after-tag">Dans 7 jours : passage à l'action</div>
            <ul className="contrast-list">
              <li>Vous utilisez la règle des 5 secondes pour amorcer vos démarches sans tarder.</li>
              <li>Vous régulez votre respiration et votre rythme cardiaque en moins de 2 minutes.</li>
        ...
        <div className="imagine-quote-box">
          <p>
            « Dans un an, vous souhaiterez avoir commencé aujourd’hui. Votre liberté d'action commence là où s'arrêtent vos hésitations. »
          </p>
